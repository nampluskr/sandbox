...
from data.oxford_pets_v2 import OxfordPetsSegmentation, collate_fn
...
if __name__ == "__main__":
    ...
    model = fcn_resnet50(weights=None, weights_backbone=None, num_classes=3)
    model.classifier[-1] = nn.Conv2d(512, 3, kernel_size=1)     # NUM_CLASSES = 3
