...
if __name__ == "__main__":
    ...
    weight_path_dict = {
        "resnet18": os.path.join(BACKBONE_DIR, "resnet18-f37072fd.pth"),
        "resnet34": os.path.join(BACKBONE_DIR, "resnet34-b627a593.pth"),
        "resnet50": os.path.join(BACKBONE_DIR, "resnet50-11ad3fa6.pth"),
        "wide_resnet50_2": os.path.join(BACKBONE_DIR, "wide_resnet50_2-95faca4d.pth"),
    }
    feature_dim_dict = {
        "resnet18": 512,
        "resnet34": 512,
    ...
    class ResNetClassifier(nn.Module):
        def __init__(self, model_name="resnet50", num_classes=10, pretrained=True):
            ...
            self.backbone.fc = nn.Linear(feature_dim_dict[model_name], num_classes)

        def forward(self, x):
            return self.backbone(x)

    model = ResNetClassifier("resnet18", num_classes=10, pretrained=True)
