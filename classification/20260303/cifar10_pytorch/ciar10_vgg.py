...
if __name__ == "__main__":
    ...
    weight_path_dict = {
        "vgg16": os.path.join(BACKBONE_DIR, "vgg16-397923af.pth"),
        "vgg19": os.path.join(BACKBONE_DIR, "vgg19-dcbb9e9d.pth"),
    }

    class VggClassifier(nn.Module):
        def __init__(self, model_name="vgg16", num_classes=10, pretrained=True):
            super().__init__()
    ...
    model = VggClassifier("vgg16", num_classes=10, pretrained=False)
