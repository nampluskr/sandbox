...
from common.utils import set_seed, create_images, sample_latent, update_history, plot_images
from common.mnist import MNISTDataset
from common.trainer import fit, evaluate
from models.gan import Discriminator, Generator, VanillaGAN
...
if __name__ == "__main__":
    ...
    train_dataset = MNISTDataset(DATA_DIR, "train", padding=True, transform=transform)
    test_dataset = MNISTDataset(DATA_DIR, "test", padding=True, transform=transform)
