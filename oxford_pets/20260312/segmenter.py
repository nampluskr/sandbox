...
class ManualSegmenter(nn.Module):
...
if __name__ == "__main__":
    ...
    train_loader = get_dataloader(DATA_DIR, "train", task="segmentation")
    test_loader = get_dataloader(DATA_DIR, "test", task="segmentation")

    NUM_EPOCHS = 3

    if 1:
        print(f"\n>> Manual Segmenter (UNet):")
        model = ManualSegmenter(in_channels=3, out_channels=3, base=64)
