...
if __name__ == "__main__":
    ...
    if 0:
        ...
        model.train()
        teature_features, student_features = model(images)

        print(f" > teature_features: {teature_features['layer1'].shape}")
        print(f" > teature_features: {teature_features['layer2'].shape}")
        print(f" > teature_features: {teature_features['layer3'].shape}")
        print(f" > student_features: {student_features['layer1'].shape}")
        print(f" > student_features: {student_features['layer2'].shape}")
        print(f" > student_features: {student_features['layer3'].shape}")
