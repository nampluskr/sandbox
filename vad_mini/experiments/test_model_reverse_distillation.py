...
from vad_mini.models.reverse_distillation.torch_model import ReverseDistillationModel
...
if __name__ == "__main__":
    ...
    if 1:
        ...
        print()
        print(f" > encoder_features: {encoder_features[0].shape}")
        print(f" > encoder_features: {encoder_features[1].shape}")
        print(f" > encoder_features: {encoder_features[2].shape}")

        print(f" > decoder_features: {decoder_features[0].shape}")
        print(f" > decoder_features: {decoder_features[1].shape}")
        print(f" > decoder_features: {decoder_features[2].shape}")
